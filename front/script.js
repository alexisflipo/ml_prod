...
btn.addEventListener('click', function() {
    ...
    fetch(`https://jeanneymar-r64mctjkzq-ew.a.run.app/predict?island=${island}&bill_length_mm=${bill_length_mm}&bill_depth_mm=${bill_depth_mm}&flipper_length_mm=${flipper_length_mm}&body_mass_g=${body_mass_g}&sex=${sexe}`).then((Response) => {
